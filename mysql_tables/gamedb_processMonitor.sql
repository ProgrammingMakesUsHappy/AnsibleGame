...
CREATE TABLE `processMonitor` (
  `pNameAndIP` varchar(45) NOT NULL,
  ...
  `Group` varchar(45) DEFAULT 'web',
  PRIMARY KEY (`pNameAndIP`),
  UNIQUE KEY `pNameAndIP_UNIQUE` (`pNameAndIP`)
...
INSERT INTO `processMonitor` VALUES ('192.168.3.1:top','top','192.168.3.1','qiushi-X270-W10DG',0.2,1,'0:12','08:42','2018-08-02 10:19:07','');
